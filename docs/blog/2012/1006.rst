...
So muss es sein::
  ...
  Lino.pcsw.IntegClients.ParamsPanel = Ext.extend(Ext.form.FormPanel,{
    ...
    initComponent : function() {
      ...
      var coached_by807 = new Lino.TwinCombo({ "fieldLabel": "Begleitet von", "name": "coached_by", "pageSize": 20, "onTrigger2Click": function(e){ Lino.show_fk_detail(this,Lino.auth.Users.detail_action)}, "emptyText": "Benutzer ausw\u00e4hlen...", "selectOnFocus": true, "hiddenName": "coached_byHidden", "anchor": "-20", "store": new Lino.ComplexRemoteComboStore({ "proxy": new Ext.data.HttpProxy({ "url": "/choices/pcsw/IntegClients/coached_by", "method": "GET" }) }) });
