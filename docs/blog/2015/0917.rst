...
<lino.mixins.clonable.Duplicate>` action to `False`.  I also removed
...
the docstring::
    ...
    Actions like :class:`InsertRow` and :class:`Clonable
    <lino.mixins.clonable.Duplicate>` which do not modify the given
