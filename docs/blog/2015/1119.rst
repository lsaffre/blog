...
<https://docs.djangoproject.com/en/6.0/topics/i18n/translation/#working-with-lazy-translation-objects>`_.
...
`say it themselves
<https://docs.djangoproject.com/en/6.0/faq/install/#what-python-version-can-i-use-with-django>`_,
