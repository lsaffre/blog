...
:ref:`sandeep` did his first code contribution: he fixed a bug which
caused :manage:`initdb` to fail on a fresh Lino development
installation because it tried to delete the SQLite database file
