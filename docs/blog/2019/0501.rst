...
that it now creates orders.

Orders arrive randomly, about daily. There are days without any offer and days
with more than one offer. Teams have their typical number of calendar entries
to generate.

This took a few hours. It's a complex but important work.  Only this step makes
the demo project useful because without any orders and calendar entries the
demo wasn't obvious to understand.  It is complex because you need to design
how to generate fictive examples which cover more or less what they want.
