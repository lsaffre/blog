...
I continued to enter our accountig data and stumbled into the next problem: An
...
- Manually enter 94.88 in :attr:`VatProductInvoice.total_incl`
- Manually enter 33.22 (94.88 * 0.35) to :attr:`InvoiceItem.total_incl`.

- Add a second invoice line and manually set :attr:`InvoiceItem.account` to
...
First question : How to instruct Lino that account ``600020`` is normally used
without VAT?
