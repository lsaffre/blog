...
Django.
`Applications <https://docs.djangoproject.com/en/3.1/ref/applications/>`_
`Migrations <https://docs.djangoproject.com/en/3.1/topics/migrations/>`_
`Field deconstruction <https://docs.djangoproject.com/en/3.1/howto/custom-model-fields/#field-deconstruction>`_
