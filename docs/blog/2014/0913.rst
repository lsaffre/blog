...
Django.
`Applications <https://docs.djangoproject.com/en/6.0/ref/applications/>`_
`Migrations <https://docs.djangoproject.com/en/6.0/topics/migrations/>`_
`Field deconstruction <https://docs.djangoproject.com/en/6.0/howto/custom-model-fields/#field-deconstruction>`_
