...
- Discovered that these test cases were not being tested anymore.  Now
  ...
  <https://github.com/lino-framework/lino-welfare/tree/master/lino_welfare/projects/docs/tests>`_
  (not in `/tests
  <https://github.com/lino-framework/lino-welfare/tree/master/tests>`_,
