...
New signal :data:`lino_cosi.lib.ledger.utils.on_ledger_movement`.  The
...
- New virtual field
  :attr:`lino_cosi.lib.ledger.models.Voucher.number_with_year`

- :class:`lino_cosi.lib.ledger.models.Voucher` now has its own
  customized :meth:`quick_search_filter
  <lino_cosi.lib.ledger.models.Voucher.quick_search_filter>` method.
