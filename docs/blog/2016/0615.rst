...
<https://github.com/lsaffre/lino_extjs6/pull/38/files>`_). I added the
...
:mod:`lino_cosi.lib.ledger.fixtures.demo_bookings` into a separate
fixture :mod:`lino_cosi.lib.sales.fixtures.demo_bookings`.  This
...
<lino_cosi.lib.finan.models.SuggestionsByBankStatement>` as an example
for our tests.
