...
extension of :mod:`lino_cosi.lib.invoicing` which, in short, adds a
...
`max_places` field was non-empty)::
    ...
    ...
      File "/cosi/lino_cosi/lib/courses/models.py", line 510, in run_from_ui
        msg = obj.get_confirm_veto(ar)
      File "/cosi/lino_cosi/lib/courses/models.py", line 609, in get_confirm_veto
        free = self.course.get_free_places(self)
      File "/cosi/lino_cosi/lib/courses/models.py", line 366, in get_free_places
