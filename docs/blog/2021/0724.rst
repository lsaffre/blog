...
I renamed :meth:`get_invoiceable_product` to :meth:`get_invoicing_product`
because this is not the product that will be invoiced, it is the product that
knows the invoicing rule (tariff) to apply.
...
- replace :meth:`get_invoicing_product` altogether by :meth:`get_invoicing_tariff`
