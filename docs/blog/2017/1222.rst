...
<https://docs.djangoproject.com/en/6.0/ref/forms/>`__:

- `The Forms API
  <https://docs.djangoproject.com/en/6.0/ref/forms/api/>`__

- `Form fields
  <https://docs.djangoproject.com/en/6.0/ref/forms/fields/>`__.

  Note the `MultiValueField
  <https://docs.djangoproject.com/en/6.0/ref/forms/fields/#multivaluefield>`__
  (aggregates the logic of multiple fields that together produce a
  single value) and the `ModelChoiceField
  <https://docs.djangoproject.com/en/6.0/ref/forms/fields/#modelchoicefield>`__.

- `The form rendering API
  <https://docs.djangoproject.com/en/6.0/ref/forms/renderers/>`__
