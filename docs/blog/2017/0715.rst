...
My summary after my first session: nice! promising!  An important
thing to try out is how to display and edit tabular data using
`QTableWidget <http://doc.qt.io/qt-5/qtablewidget.html>`_.
