...
- Next problem::
    ...
    django.core.exceptions.ImproperlyConfigured: GEOS is required and has not been detected. Are you sure it is installed? See also https://docs.djangoproject.com/en/6.0/ref/contrib/gis/install/geolibs/

  I read the `1.11 version
  <https://docs.djangoproject.com/en/6.0/ref/contrib/gis/install/geolibs/>`__ and consultd with Kimmo. Solution::
...
<https://docs.djangoproject.com/en/6.0/topics/auth/default/#django.contrib.auth.authenticate>`__
