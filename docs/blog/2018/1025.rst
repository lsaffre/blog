...
A historic release for :ref:`weleup`
====================================

Today, one month after the last release attempt, we finally managed to
get them to the new version.  :ref:`weleup` is one of our biggest
sites, and it was an exciting challenge to develop the "secure release
procedure" (explained under :ref:`hosting.testing`).  Lino is reaching
...
As if the release in :ref:`weleup` wasn't enough, and as a contrast, I
