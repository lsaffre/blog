...
But I continued also today with this.  
...
**********************************************************************
File "/media/dell1tb/work/book/docs/specs/dumps.rst", line 88, in dumps.rst
Failed example:
...
Got:
    Writing /media/dell1tb/work/book/lino_book/projects/dumps/tmp/a/restore.py...
    Traceback (most recent call last):
      File "manage_a.py", line 7, in <module>
        execute_from_command_line(sys.argv)
      File "/media/dell1tb/virtualenvs/py27/local/lib/python2.7/site-packages/django/core/management/__init__.py", line 364, in execute_from_command_line
        utility.execute()
      File "/media/dell1tb/virtualenvs/py27/local/lib/python2.7/site-packages/django/core/management/__init__.py", line 356, in execute
        self.fetch_command(subcommand).run_from_argv(self.argv)
      File "/media/dell1tb/virtualenvs/py27/local/lib/python2.7/site-packages/django/core/management/base.py", line 283, in run_from_argv
        self.execute(*args, **cmd_options)
      File "/media/dell1tb/virtualenvs/py27/local/lib/python2.7/site-packages/django/core/management/base.py", line 330, in execute
        output = self.handle(*args, **options)
      File "/media/dell1tb/work/lino/lino/management/commands/dump2py.py", line 529, in handle
        self.write_files()
      File "/media/dell1tb/work/lino/lino/management/commands/dump2py.py", line 296, in write_files
        self.models = self.sort_models(self.models)
      File "/media/dell1tb/work/lino/lino/management/commands/dump2py.py", line 422, in sort_models
