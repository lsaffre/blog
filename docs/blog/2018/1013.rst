...
.. Today I pushed several changes I did on :doc:`1010` :doc:`1011`. I
   didn't commit them earlier because only now I got the test suite
   passing again.  It's the kind of habits I must get rid of when Lino
   will grow because in an industry-standard project every change must
   be atomic and well documented...
