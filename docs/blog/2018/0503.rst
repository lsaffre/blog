...
<https://docs.djangoproject.com/en/6.0/topics/testing/overview/#order-in-which-tests-are-executed>`__ section of the Django docs.
...
<https://docs.djangoproject.com/en/6.0/ref/django-admin/#cmdoption-test-reverse>``
option::
...
<https://docs.djangoproject.com/en/6.0/topics/testing/tools/#django.test.TransactionTestCase.fixtures>`__.  
