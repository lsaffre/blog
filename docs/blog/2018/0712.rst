...
<https://docs.djangoproject.com/en/1.11/topics/db/examples/one_to_one/>`__
than as an injected ForeignKey field.  The problem with
:func:`lino.core.fields.OneToOneField` fields was that Lino did not
yet handle them in a useful way.  Now it does.
