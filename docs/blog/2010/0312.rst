...
[https://docs.djangoproject.com/en/5.0/ref/templates/builtins/#safe safe]. Also im Template musste ich lediglich das `{{instance.text}}` durch `{{instance.text|safe}}` ersetzen. 
