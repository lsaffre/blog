...
Ich hab was verstanden: um Scripts wie :xfile:`initdb.py`, :xfile:`load_tim.py`, :xfile:`send_invoices.py` durch `django-admin commands <https://docs.djangoproject.com/en/3.2/howto/custom-management-commands/#howto-custom-management-commands>`_ zu ersetzen, brauche ich wahrscheinlich ein `Signal <https://docs.djangoproject.com/en/3.2/topics/signals/>`_, das bei jedem Start eines Management Tools nach dem Laden der Modelle gefeuert wird...
