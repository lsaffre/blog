...
- `403 / forbidden / PermissionDenied (Django 1.5) 
  <https://docs.djangoproject.com/en/6.0/topics/http/views/#the-403-http-forbidden-view>`_
- `400 / bad request / SuspiciousOperation (Django 1.6) 
  <https://docs.djangoproject.com/en/6.0/topics/http/views/#the-400-bad-request-view>`_
